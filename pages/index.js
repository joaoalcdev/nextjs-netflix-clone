  ...
  return (
    ...
    >
      ...
      <header className="flex justify-between w-full px-12 py-8">
        ...
        {/* <div>
          <button
            onClick={() => language('alert')}
            className="flex items-center bg-black-700 hover:bg-[#e50914] hover:border-gray text-white hover:text-white py-2 px-4 border border-white-500 hover:border-transparent rounded"
          >
            🌐 Englist
          </button>
        </div> */}
        <div className="">
          {!session ? (
            <button
              ...
              className="flex items-center bg-[#e50914] text-white text-tiny px-[1.175rem] py-[.325rem] rounded"
            >
              Sign In
            </button>
          ) : (
            <button
              onClick={() => signOut()}
              className="flex items-center bg-[#e50914] text-white text-tiny px-[1rem] py-[.325rem] rounded"
            >
              Sign Out
            </button>
          )}
      ...
      <main className="flex flex-col items-center justify-center flex-1 px-20 text-center">
        ...
        <div className="flex mt-4">
          ...
          <button
            onClick={() => signIn()}
            className="flex items-center bg-[#e50914] text-white text-lg px-8"
          >
            Get Started
            <svg
              xmlns="http://www.w3.org/2000/svg"
